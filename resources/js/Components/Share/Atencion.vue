                ...
                <div class="layoutContainer">
                    <div class="formContainer">
                        ...
                        <div class="titularContainer">
                            <h2>
                                Encuentre la solución <br />MasterMover ideal
                                para <br />su operación
                            </h2>
                        </div>
                        <div class="descriptionContainer">
                            <p>
                                Complete el formulario y uno de nuestros
                                especialistas analizará sus necesidades para
                                recomendarle el remolcador eléctrico más
                                adecuado, brindarle asesoría técnica y elaborar
                        ...
                        >
                            <div class="formGrid">
                                ...
                                <div class="field field--full">
                                    <label for="solucion"
                                        >¿Qué solución está buscando?</label
                                    >
                                    <select
                                        id="solucion"
                                        v-model="solucion"
                                        v-bind="solucionAttrs"
                                        :class="{
                                            'is-invalid': errors.solucion,
                                            'is-placeholder': !solucion,
                                        }"
                                ...
                                <div class="field field--full">
                                    <label for="proyecto"
                                        >Describa brevemente su proyecto</label
                                    >
                                    <textarea
                                        id="proyecto"
                                        v-model="proyecto"
...
import { contactoSchema, SOLUCIONES } from "./contactoSchema";
...
// Select y checkbox validan al cambiar: el cambio ya es una acción deliberada.
const [solucion, solucionAttrs] = defineField("solucion");
