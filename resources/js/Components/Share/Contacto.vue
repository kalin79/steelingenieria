                ...
                <div class="layoutContainer">
                    <div class="formContainer">
                        ...
                        <div class="titularContainer">
                            <h2>
                                El próximo gran <br />proyecto comienza aquí
                            </h2>
                        </div>
                        <div class="descriptionContainer">
                            <p>
                                Cada operación enfrenta desafíos únicos. Déjenos
                                conocer sus objetivos y desarrollaremos una
                                solución de ingeniería alineada con las
                                necesidades actuales y futuras de su negocio.
                            </p>
                        </div>
                        <form
                            class="formContacto"
...
.sectionContacto {
    ...
    .bgContacto {
        width: 100%;
        height: 470px;
        background-image: url("/images/bgontacto.webp");
        background-position: center;
        background-size: cover;
        background-repeat: no-repeat;
        @media screen and (min-width: 992px) {
